      ...
      <VerticalTimeline>
        ...
        >
          <div className="col d-flex justify-content-center text-center">
            <Card
              cardBody="Teaching K-12 students computer science."
              cardCaption="Coding Instructor"
              cardImg="https://members-csforall.imgix.net/members/logos/logo-vertical-yellow-backbgrnd-lowres.jpg"
              title="Learn2Code"
            ></Card>
          </div>
        </VerticalTimelineElement>
